...
namespace WorkoutTracker.Data
{
  public static class DbInitializer
  {
    public static void Initialize(WorkoutTrackerContext context)
    {
      ...
      {
        new() {Id = 1, UserId = 1, ExerciseId = 1, Repetitions = 6, Sets = 4, Weight = 35, EquipmentType = EquipmentType.BigBarbell},
        new() {Id = 2, UserId = 1, ExerciseId = 2, Repetitions = 6, Sets = 4, Weight = 7.5m, EquipmentType = EquipmentType.BigBarbell},
        new() {Id = 3, UserId = 1, ExerciseId = 3, Repetitions = 6, Sets = 4, Weight = 10, EquipmentType = EquipmentType.BigBarbell},
        new() {Id = 4, UserId = 1, ExerciseId = 4, Repetitions = 7, Sets = 4, Weight = 40, EquipmentType = EquipmentType.SmallBarbell},
        ...
        new() {Id = 7, UserId = 1, ExerciseId = 13, Repetitions = 6, Sets = 4, Weight = 10, EquipmentType = EquipmentType.BigBarbell},
        new() {Id = 8, UserId = 1, ExerciseId = 6, Repetitions = 6, Sets = 4, Weight = 20, EquipmentType = EquipmentType.SmallBarbell},
        new() {Id = 9, UserId = 1, ExerciseId = 7, Repetitions = 12, Sets = 4, Weight = 25, EquipmentType = EquipmentType.Machine},
        new() {Id = 10, UserId = 1, ExerciseId = 13, Repetitions = 6, Sets = 4, Weight = 17.5m, EquipmentType = EquipmentType.Dumbbell},
        new() {Id = 11, UserId = 1, ExerciseId = 1, Repetitions = 6, Sets = 4, Weight = 20, EquipmentType = EquipmentType.Machine},
        new() {Id = 12, UserId = 1, ExerciseId = 8, Repetitions = 6, Sets = 4, Weight = 20, EquipmentType = EquipmentType.Machine},
        new() {Id = 13, UserId = 1, ExerciseId = 9, Repetitions = 6, Sets = 4, Weight = 20, EquipmentType = EquipmentType.Machine},
        ...
        new() {Id = 16, UserId = 1, ExerciseId = 11, Repetitions = 6, Sets = 4, Weight = 20, EquipmentType = EquipmentType.SmallBarbell},
